...
ActiveRecord::Schema[7.1].define(version: 20_250_209_171_700) do
  ...
  create_table 'auto_bids', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[auction_id maximum_amount created_at], name: 'index_auto_bids_for_processing'
    t.index %w[auction_id maximum_amount], name: 'index_auto_bids_on_auction_id_and_maximum_amount'
    t.index ['auction_id'], name: 'index_auto_bids_on_auction_id'
    t.index %w[user_id auction_id], name: 'index_auto_bids_on_user_id_and_auction_id', unique: true
  ...
  create_table 'bids', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[auction_id amount], name: 'index_bids_by_amount'
    t.index %w[auction_id amount], name: 'index_bids_on_auction_id_and_amount'
    t.index %w[auction_id user_id created_at], name: 'index_bids_for_history'
    t.index ['auction_id'], name: 'index_bids_on_auction_id'
    t.index %w[user_id created_at], name: 'index_bids_by_user_and_date'
